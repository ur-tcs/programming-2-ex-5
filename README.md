...
This exercise is made of two distinct folder, [higer_order](higher_order) and [boids](boids). We recommend you to open them one at a time to avoid VSCode build's issues.
